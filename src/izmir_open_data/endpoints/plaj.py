...
class PlajEndpoint(BaseEndpoint):
    async def get_plajlar_list(self) -> OnemliYerWrapper[Plaj]:
        ...
        """
        return await self._client.get("ibb/cbs/plajlar", response_model=OnemliYerWrapper[Plaj])
    ...
    async def get_hamamlar_list(self) -> OnemliYerWrapper[Plaj]:
        ...
        """
        return await self._client.get("ibb/cbs/hamamlar", response_model=OnemliYerWrapper[Plaj])
    ...
    async def get_kaplicalar_list(self) -> OnemliYerWrapper[Plaj]:
        ...
        """
        return await self._client.get("ibb/cbs/kaplicalar", response_model=OnemliYerWrapper[Plaj])
    ...
    async def get_fuar_list(self) -> OnemliYerWrapper[Plaj]:
        ...
        """
        return await self._client.get("ibb/cbs/fuar", response_model=OnemliYerWrapper[Plaj])
